 ...
 *
 * There is one editor for all of them — Survey Creator, opened on one form — and
 * it is a URL worth sharing: `/configure?form=<id>`.
 *
...
const SOURCE_ROOT =
  "https://github.com/surveyjs/surveyjs-nextjs/blob/main/src/schemas";
